...
namespace RuntimeInspectorNamespace
{
    public class GameObjectField : ExpandableInspectorField
    {
        ...
        protected override void GenerateElements()
        {
            ...
            {
                var drawer = CreateDrawerForComponent(components[i]);

				// Auto expand the RuntimeController
                if (components[i].GetType().IsSubclassOf(typeof(RuntimeController)))
                    ((ExpandableInspectorField)drawer).IsExpanded = true;
            }
